<div id="edit-ustadz-modal-{{ $ustadz->id }}" class="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
            <div class="p-4 overflow-y-auto max-h-[90vh]">
                <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                    <h3 class="font-bold text-gray-800 dark:text-white">Edit Data Ustadz</h3>
                    <button type="button" class="flex justify-center items-center size-7 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-neutral-700" data-hs-overlay="#edit-ustadz-modal-{{ $ustadz->id }}">
                ...
                <form method="POST" action="{{ route('ustadz.update', $ustadz) }}" enctype="multipart/form-data" class="p-4">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nip" required value="{{ $ustadz->nip }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="full_name" required value="{{ $ustadz->full_name }}"
                                       class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="gender" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600">
                                    <option value="L" {{ $ustadz->gender === 'L' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="P" {{ $ustadz->gender === 'P' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="birth_date" required value="{{ $ustadz->birth_date->format('Y-m-d') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="birth_place" required value="{{ $ustadz->birth_place }}"
                                       class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="address" required rows="3"
                                          class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">{{ $ustadz->address }}</textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="phone" required value="{{ $ustadz->phone }}"
                                           class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-2 dark:text-white">Email *</label>
                                    <input type="email" name="email" required value="{{ $ustadz->email }}"
                                           class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                @if($ustadz->photo_path)
                                    <div class="mb-2">
                                        <img src="{{ $ustadz->photo_url }}" alt="Current photo" class="w-20 h-20 object-cover rounded-lg">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="education_level" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600">
                                    <option value="SMA" {{ $ustadz->education_level === 'SMA' ? 'selected' : '' }}>SMA/Sederajat</option>
                                    <option value="D3" {{ $ustadz->education_level === 'D3' ? 'selected' : '' }}>D3</option>
                                    <option value="S1" {{ $ustadz->education_level === 'S1' ? 'selected' : '' }}>S1</option>
                                    <option value="S2" {{ $ustadz->education_level === 'S2' ? 'selected' : '' }}>S2</option>
                                    <option value="S3" {{ $ustadz->education_level === 'S3' ? 'selected' : '' }}>S3</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="education_major" value="{{ $ustadz->education_major }}"
                                       class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="certification" value="{{ $ustadz->certification }}"
                                       class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="join_date" required value="{{ $ustadz->join_date->format('Y-m-d') }}"
                                       class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="employment_status" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600">
                                    <option value="tetap" {{ $ustadz->employment_status === 'tetap' ? 'selected' : '' }}>Tetap</option>
                                    <option value="honorer" {{ $ustadz->employment_status === 'honorer' ? 'selected' : '' }}>Honorer</option>
                                    <option value="magang" {{ $ustadz->employment_status === 'magang' ? 'selected' : '' }}>Magang</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="status" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600">
                                    <option value="active" {{ $ustadz->status === 'active' ? 'selected' : '' }}>Aktif</option>
                                    <option value="inactive" {{ $ustadz->status === 'inactive' ? 'selected' : '' }}>Tidak Aktif</option>
                                    <option value="resign" {{ $ustadz->status === 'resign' ? 'selected' : '' }}>Resign</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="user_role" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600">
                                    <option value="admin" {{ $ustadz->user->role === 'admin' ? 'selected' : '' }}>Administrator</option>
                                    <option value="ustadz" {{ $ustadz->user->role === 'ustadz' ? 'selected' : '' }}>Ustadz/Ustadzah</option>
                                    <option value="pengurus" {{ $ustadz->user->role === 'pengurus' ? 'selected' : '' }}>Pengurus</option>
                                </select>
                            </div>
                                    ...
                                    @foreach($roles as $role)
                                        <div class="flex items-center">
                                            <input type="checkbox" name="roles[]" value="{{ $role->id }}" 
                                                   {{ $ustadz->roles->contains($role->id) ? 'checked' : '' }}
                    ...
                    <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-neutral-700 mt-6">
                        <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800" data-hs-overlay="#edit-ustadz-modal-{{ $ustadz->id }}">
                            Batal
                        </button>
