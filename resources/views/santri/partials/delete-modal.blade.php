<!-- Delete Modal -->
<div id="delete-santri-modal-{{ $santri->id }}" class="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto backdrop-brightness-50">
