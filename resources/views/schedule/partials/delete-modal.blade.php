<div id="delete-schedule-modal-{{ $schedule->id }}" class="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto backdrop-brightness-50">
  <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
      ...
      <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
        <h3 class="font-bold text-gray-800 dark:text-white">Hapus Jadwal</h3>
        <button type="button"
      ...
      <div class="p-4">
        <p class="text-gray-700 dark:text-gray-300">
          Yakin ingin menghapus jadwal <span class="font-semibold">{{ $schedule->title }}</span> pada {{ $schedule->date->format('d M Y') }}?
        </p>
      </div>
